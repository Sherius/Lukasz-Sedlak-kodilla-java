...
public class BookDirectoryTestSuite {
    ...
    private List<Book> generateListOfNBooks(int booksQuantity) {
        ...
        for (int n = 1; n <= booksQuantity; n++) {
            Book theBook = new Book("Title", "Author", 1970 + n);
    ...
    public void testListBooksWithConditionFragmentShorterThan3() {
        ...
        //When
        List<Book> theLlistOfBooks10 = bookLibrary.listBooksWithCondition("an");
    ...
    public void testListOfBooksInHandsEqual1(){
        ...
        List<Book> userBooks = bookLibrary.listBooksInHandsOf(libraryUser);
        userBooks.add(new Book("title", "author", 1970));
        //Then
    ...
    public void testListOfBooksInHandEqual5() {
        ...
        LibraryDatabase libraryDatabaseMock = mock(LibraryDatabase.class);
        BookLibrary bookLibrary = new BookLibrary(libraryDatabaseMock);
        LibraryUser libraryUser = new LibraryUser("Name", "Surname", "One");
        List<Book> bookList = generateListOfNBooks(5);


        when(libraryDatabaseMock.listBooksInHandsOf(libraryUser)).thenReturn(bookList);
        //When
        List<Book> bookList1 = bookLibrary.listBooksInHandsOf(libraryUser);
        //Then
